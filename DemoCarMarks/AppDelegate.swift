...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UISearchBar.appearance().barTintColor = UIColor.rbBlack
        UISearchBar.appearance().tintColor = UIColor.rbGreen
        UISearchBar.appearance().backgroundColor = UIColor.rbBlack
        UITextField.appearance(whenContainedInInstancesOf: [UISearchBar.self]).keyboardAppearance = .dark
        UITextField.appearance(whenContainedInInstancesOf: [UISearchBar.self]).tintColor = UIColor.rbGreen
